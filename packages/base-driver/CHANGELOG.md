...
## [11.0.1](https://github.com/TestSpectra/appium/compare/@testspectra/base-driver@11.0.0...@testspectra/base-driver@11.0.1) (2026-04-28)
...
* **appium:** remove support for -custom locator strategy(should be handled by plugins instead) (#15452)
...
* Add a missing route for element shadow root ([#16538](https://github.com/TestSpectra/appium/issues/16538)) ([493c48d](https://github.com/TestSpectra/appium/commit/493c48d190373e188f5a8a3c416ebddc6a17189b))
...
* **appium:** expose validateCaps in basedriver index ([#15451](https://github.com/TestSpectra/appium/issues/15451)) ([21e8d60](https://github.com/TestSpectra/appium/commit/21e8d60a5c768762ebaa7a3232962b0dec385bd0))
...
* **base-driver:** add /se route for log ([#15788](https://github.com/TestSpectra/appium/issues/15788)) ([71e50c5](https://github.com/TestSpectra/appium/commit/71e50c5619b854afb5e14a789e6dba94802c1c5b))
* **base-driver:** Add a route for new window creation ([#16748](https://github.com/TestSpectra/appium/issues/16748)) ([78a4637](https://github.com/TestSpectra/appium/commit/78a46375aed016feb6e2b20299cc834d2d24e1cb))
* **base-driver:** add ability to supply custom headers for proxy ([#21790](https://github.com/TestSpectra/appium/issues/21790)) ([a4b47c0](https://github.com/TestSpectra/appium/commit/a4b47c02c6e72381fa9d191d2a0bced106999705))
...
* **base-driver:** Add more shadow root-related W3C routes ([#16700](https://github.com/TestSpectra/appium/issues/16700)) ([d8a9b4d](https://github.com/TestSpectra/appium/commit/d8a9b4da362c0ee3d1616595a9f652a59b178065))
* **base-driver:** Add onDownload handler to the configureApp helper ([#20015](https://github.com/TestSpectra/appium/issues/20015)) ([8cf3efd](https://github.com/TestSpectra/appium/commit/8cf3efdbed6c0868f2d7838e249a3d2478f186d4))
...
* **base-driver:** Add the original app link argument to configureApp callbacks ([#20035](https://github.com/TestSpectra/appium/issues/20035)) ([3423fd9](https://github.com/TestSpectra/appium/commit/3423fd9206f71481bb34919e02a3dc8c5e3bec00))
* **base-driver:** Add the size validation of the passed settings objects ([#16420](https://github.com/TestSpectra/appium/issues/16420)) ([a881ae9](https://github.com/TestSpectra/appium/commit/a881ae992abfddcdb9fd27d699ce8b824847ed47))
* **base-driver:** allow drivers, and plugins to declare that certain routes must never be proxied ([3e5aec9](https://github.com/TestSpectra/appium/commit/3e5aec945bc0493dbd14d0759e5e35749e974aac))
...
* **base-driver:** Drop the unzip logic from basedriver helpers ([#21105](https://github.com/TestSpectra/appium/issues/21105)) ([45c6c42](https://github.com/TestSpectra/appium/commit/45c6c42e8fa8b680cdd5ec6cbee2027f7fbdc557))
* **base-driver:** generate declaration files ([164bedb](https://github.com/TestSpectra/appium/commit/164bedb2f13e0c3ab7d27644107bc2320bb02db9))
...
* **base-driver:** prefer system unzip ([25cc27d](https://github.com/TestSpectra/appium/commit/25cc27d161e9425a2ce7420d4417f85d03984921))
* **base-driver:** Print the closest match if the given script did not match ([#20956](https://github.com/TestSpectra/appium/issues/20956)) ([f8b5799](https://github.com/TestSpectra/appium/commit/f8b57999e5a4a13a089cff12954de5d99c8a35fc))
...
* **base-driver:** Show known capability name matches for typos ([#22193](https://github.com/TestSpectra/appium/issues/22193)) ([4c4e8d8](https://github.com/TestSpectra/appium/commit/4c4e8d89110975fbcf71fceaf99c5a76636d211f))
* **base-driver:** support appium:options capability to hold all appium caps ([4f1bf3d](https://github.com/TestSpectra/appium/commit/4f1bf3d3b8fdeb69ea9a816ee9819c62f0c10bb8))
* **base-driver:** Use `markSensitive` to mask password input field value ([#21118](https://github.com/TestSpectra/appium/issues/21118)) ([aa5d794](https://github.com/TestSpectra/appium/commit/aa5d794ff3286076859e6b5e38026fa6c3e62e2c))
...
* **base:** add get computed role and label in W3C v2 ([#17928](https://github.com/TestSpectra/appium/issues/17928)) ([316ecca](https://github.com/TestSpectra/appium/commit/316ecca8b1f8e52806867a15ba8524a504751460))
...
* **fake-driver:** add a new 'PROXY' context that does 'proxying' for use in testing ([9e6c0a1](https://github.com/TestSpectra/appium/commit/9e6c0a13ef197c3a8caa9e18bdf4f8e6960951f1))
...
* add 'webSocketUrl' as standard cap for bidi support ([#17936](https://github.com/TestSpectra/appium/issues/17936)) ([0e195ca](https://github.com/TestSpectra/appium/commit/0e195caafefe911586ee2f8be4ae33d402b2ba40))
* adjust parameter for W3C element send keys endpoint ([#21149](https://github.com/TestSpectra/appium/issues/21149)) ([2cb3a31](https://github.com/TestSpectra/appium/commit/2cb3a31252cf0190180acf0c353112880d586b31))
...
* **base-driver,driver-test-support,support:** update types for axios@1.2.3 ([c5451e4](https://github.com/TestSpectra/appium/commit/c5451e4d8280483dabca6e0bc62736689406d3df))
...
* **base-driver,types:** fix websocket-related types on AppiumServer ([34891f5](https://github.com/TestSpectra/appium/commit/34891f56572f18dd740558b2348d8818680dc709))
* **base-driver,types:** For extension commands that use prefix "mobile", ensure logEvents() has the name of executed script ([#21416](https://github.com/TestSpectra/appium/issues/21416)) ([c410201](https://github.com/TestSpectra/appium/commit/c410201baa701dfe2dc43feac71f0c7ea21b1bd2))
* **base-driver:** /timeouts API arguments ([#21238](https://github.com/TestSpectra/appium/issues/21238)) ([c7a20d8](https://github.com/TestSpectra/appium/commit/c7a20d8d7df6c2f784eedda862fc66b1a5aa7b89))
* **base-driver:** add * always for non-separator for backward compatibility ([#20821](https://github.com/TestSpectra/appium/issues/20821)) ([6ea0830](https://github.com/TestSpectra/appium/commit/6ea0830319c204097233d0659e21b3447b624431))
...
* **base-driver:** add missing @types/lodash ([63a429c](https://github.com/TestSpectra/appium/commit/63a429c53bf3da353e018ed86ec24e32bf238d18))
* **base-driver:** add missing dependency @appium/types ([edde488](https://github.com/TestSpectra/appium/commit/edde4882f0633c032a077861599c337132092daf)), closes [#18006](https://github.com/TestSpectra/appium/issues/18006)
* **base-driver:** allow https in helper URL generation ([cf86871](https://github.com/TestSpectra/appium/commit/cf86871d4f5d3cf7f9865dd2409bd306a5dd920a))
* **base-driver:** allow subclass to define shape of settings object ([3d614d6](https://github.com/TestSpectra/appium/commit/3d614d6d414d0d34026f516dbfad7d296000efcf))
* **base-driver:** Avoid RangeError while caching the response data ([#19043](https://github.com/TestSpectra/appium/issues/19043)) ([315a5e6](https://github.com/TestSpectra/appium/commit/315a5e6cc75d53d5fbbdae598dc4523ab85b7cb1))
* **base-driver:** better URL handling in driver-e2e tests ([01d7c1b](https://github.com/TestSpectra/appium/commit/01d7c1bd7ebfa9a54b22d04f81c24ee95bec0962))
* **base-driver:** calls startNewCommandTimeout before returning NotYetImplementedError ([#20380](https://github.com/TestSpectra/appium/issues/20380)) ([6a97fe4](https://github.com/TestSpectra/appium/commit/6a97fe48aebb85424fa7e5be5de2eb5524cf0db6))
* **base-driver:** change required to option for setWindowRect to follow w3c ([#20391](https://github.com/TestSpectra/appium/issues/20391)) ([9eb65f7](https://github.com/TestSpectra/appium/commit/9eb65f7ad4efc89bbf5af89791bb9eb81fc2248f))
* **base-driver:** Check if app path is relative earlier ([#20276](https://github.com/TestSpectra/appium/issues/20276)) ([2882e71](https://github.com/TestSpectra/appium/commit/2882e7163159b7918d54cc4521105a1fdf55da9a))
* **base-driver:** create cjs wrapper ([85cd55b](https://github.com/TestSpectra/appium/commit/85cd55bc2c54e2091dec69ead1462c5f022e590b))
* **base-driver:** do not throw if updateSettings aren't provided ([2d76923](https://github.com/TestSpectra/appium/commit/2d76923e7232592f32c30731f2879a16b3e27b17))
* **base-driver:** don't assign log to jwproxy from opts ([eae3efd](https://github.com/TestSpectra/appium/commit/eae3efd1d7d2bd515e8e2844e1e16324a91ae47d))
* **base-driver:** Drop unknown method arguments ([#21245](https://github.com/TestSpectra/appium/issues/21245)) ([748c7e0](https://github.com/TestSpectra/appium/commit/748c7e0c6d59a5ff2282a52a60d098e3a73379b9))
* **base-driver:** ensure caps is defined ([1e00faf](https://github.com/TestSpectra/appium/commit/1e00faf1a4cf4b72cbb23997fa895e1fb48a06ce))
* **base-driver:** fix /computedrole and /computedlabel routes ([#21551](https://github.com/TestSpectra/appium/issues/21551)) ([3034fe9](https://github.com/TestSpectra/appium/commit/3034fe9b7cd9a461bb4d25a0cd7167888c08254b))
* **base-driver:** Fix possible NPE while cleaning up the state listener ([#19020](https://github.com/TestSpectra/appium/issues/19020)) ([53bfc68](https://github.com/TestSpectra/appium/commit/53bfc68eee5766ca8c6851c424c89d6b123d602e))
* **base-driver:** fix session id handling more ([#21962](https://github.com/TestSpectra/appium/issues/21962)) ([d734b4c](https://github.com/TestSpectra/appium/commit/d734b4c200ac2e4416a0a61074c2f48897b6529d))
* **base-driver:** fix the LRUCache.dispose callback param order ([#19037](https://github.com/TestSpectra/appium/issues/19037)) ([abcf0d4](https://github.com/TestSpectra/appium/commit/abcf0d451f47f5c7c285f0988693c4bef9c29024))
* **base-driver:** fix timeout mixin to use proper context types ([51a8f2f](https://github.com/TestSpectra/appium/commit/51a8f2fc347f0b4e222ca2e8dc92fa4bdf44d1e3))
* **base-driver:** fix type problem w/r/t axios headers ([61a0275](https://github.com/TestSpectra/appium/commit/61a0275e29e7a705785282415fd670a3ad617f18))
* **base-driver:** follow W3C capabilities more strictly ([#16193](https://github.com/TestSpectra/appium/issues/16193)) ([9a85a41](https://github.com/TestSpectra/appium/commit/9a85a41b9e134949ed5743ccdcf6bd83ee11df14))
* **base-driver:** Ignore unknown script arguments ([#18575](https://github.com/TestSpectra/appium/issues/18575)) ([4f564ef](https://github.com/TestSpectra/appium/commit/4f564ef7ad350831b90994ffd4e8b00de227577d))
* **base-driver:** isErrorType import ([ad3b4b2](https://github.com/TestSpectra/appium/commit/ad3b4b2c9676623a5eeb92e0beb510ec181fbcf8))
* **base-driver:** lint warnings ([#22174](https://github.com/TestSpectra/appium/issues/22174)) ([943866b](https://github.com/TestSpectra/appium/commit/943866bcf3c823c7d57b001ccb345cde4f4d2c4d))
* **base-driver:** Make it work with Express5 ([#20789](https://github.com/TestSpectra/appium/issues/20789)) ([e1e00ed](https://github.com/TestSpectra/appium/commit/e1e00ed97afdd8f0ce1505761102901aadb86919))
* **base-driver:** Make proxy timeout mutable again ([#22154](https://github.com/TestSpectra/appium/issues/22154)) ([dfe8bde](https://github.com/TestSpectra/appium/commit/dfe8bde6877b5233a7cba48b319045e29dde3c98))
* **base-driver:** Make sure proxyReqRes helper never throws any exceptions ([#16742](https://github.com/TestSpectra/appium/issues/16742)) ([5d2156a](https://github.com/TestSpectra/appium/commit/5d2156a06bcf621116db0adbedce431d7c18fca7))
* **base-driver:** Make sure we never mutate incoming args ([#16670](https://github.com/TestSpectra/appium/issues/16670)) ([c63e9bf](https://github.com/TestSpectra/appium/commit/c63e9bf8e0f42e6e070ca662d0b6079a5e7284e2))
* **base-driver:** misc type fixes ([d303527](https://github.com/TestSpectra/appium/commit/d303527c3da4f657a28b97a2d82eb1a709c6b9bc))
* **base-driver:** more random ports ([b864fa5](https://github.com/TestSpectra/appium/commit/b864fa5310a973c0c86723c0dceee70bf9743d79))
* **base-driver:** move setClipboard deprecation to correct place ([ad1dce5](https://github.com/TestSpectra/appium/commit/ad1dce5545acb61ce79e489783a95f2caebd753c))
* **base-driver:** Optimize the logic of getUrlForProxy ([#21018](https://github.com/TestSpectra/appium/issues/21018)) ([8a664a4](https://github.com/TestSpectra/appium/commit/8a664a4eef97f45c5bdf7f19708149488b63d7fc))
* **base-driver:** pass thru all type args to ExternalDriver ([2b35170](https://github.com/TestSpectra/appium/commit/2b351705d401e2db8da76022989c1475cbdda0f8))
* **base-driver:** Properly validate capabilities inside appium:options map ([#17781](https://github.com/TestSpectra/appium/issues/17781)) ([9190115](https://github.com/TestSpectra/appium/commit/91901153a12a5d1e589e15f4ec2415a125ddc159))
* **base-driver:** remove needless static prop breaking the build ([1b70551](https://github.com/TestSpectra/appium/commit/1b70551055444cad97144e539da7be872b9f70f8))
* **base-driver:** Respect basic auth credentials if provided ([#19000](https://github.com/TestSpectra/appium/issues/19000)) ([ed8e83c](https://github.com/TestSpectra/appium/commit/ed8e83c76c5b660e619833515c2ea2ec29082e18))
* **base-driver:** Restore the legacy proxy url behaviour ([#21021](https://github.com/TestSpectra/appium/issues/21021)) ([dd64a48](https://github.com/TestSpectra/appium/commit/dd64a48fca047a728ad109d525bc4787daa75edc))
* **base-driver:** Return an empty object if the corresponding API response is undefined ([#20845](https://github.com/TestSpectra/appium/issues/20845)) ([c765bc3](https://github.com/TestSpectra/appium/commit/c765bc31e03d37ed194fcd52f4e4a2ca1128b260))
* **base-driver:** Start command timeout even if the recent command has thrown an exception ([#20379](https://github.com/TestSpectra/appium/issues/20379)) ([139dbae](https://github.com/TestSpectra/appium/commit/139dbaeef6963f79a1de38541181bae8953e00e1))
* **base-driver:** supportedLogTypes does not get overwritten ([ab6dfb3](https://github.com/TestSpectra/appium/commit/ab6dfb3158e192b42313d6b1d8648ffc672af8bd)), closes [#16738](https://github.com/TestSpectra/appium/issues/16738)
* **base-driver:** Tune capabilities array parsing ([#21044](https://github.com/TestSpectra/appium/issues/21044)) ([594bc04](https://github.com/TestSpectra/appium/commit/594bc04c03fb073cd7ad31d7e23f77fb8041b92e))
* **base-driver:** Tune responses caching logic ([#18922](https://github.com/TestSpectra/appium/issues/18922)) ([de5b55a](https://github.com/TestSpectra/appium/commit/de5b55ae90fefcce86962a48d5aceb73962e56b6))
* **base-driver:** type inconsistency ([#15982](https://github.com/TestSpectra/appium/issues/15982)) ([0e63393](https://github.com/TestSpectra/appium/commit/0e633939f9b6451899ce963391eaeb9e44bbba5d))
* **base-driver:** update def of findElOrEls and findElOrElsWithProcessing ([54a4a8d](https://github.com/TestSpectra/appium/commit/54a4a8da030dbecde783168bb92634df837d5a41))
* **base-driver:** update definitelytyped ([5e09589](https://github.com/TestSpectra/appium/commit/5e095893ee8f65cb8744d2cd6c6abd70f402fa55))
* **base-driver:** update definitelytyped ([c2289ad](https://github.com/TestSpectra/appium/commit/c2289ad607e1af0aa1182a5b5ab707c5dbf12922))
* **base-driver:** update dependency @types/method-override to v3 ([#20799](https://github.com/TestSpectra/appium/issues/20799)) ([42ef484](https://github.com/TestSpectra/appium/commit/42ef4841f9a379d8e9ce531eb5375eab03902e3f))
...
* **base-driver:** update dependency body-parser to v1.20.2 ([1cb01a5](https://github.com/TestSpectra/appium/commit/1cb01a5e85e7aee54ce1edc751e104138852d59a))
* **base-driver:** update dependency body-parser to v1.20.3 ([056baba](https://github.com/TestSpectra/appium/commit/056baba3a0c51973d5e834283355821eced6ee17))
* **base-driver:** update dependency express to v4.18.3 ([917084c](https://github.com/TestSpectra/appium/commit/917084ccca23c5483e7d83ce97721061dd2fe345))
* **base-driver:** update dependency express to v4.19.1 ([a74132c](https://github.com/TestSpectra/appium/commit/a74132cc96d201bb5c7b7f11a7e3b1b79e7d2424))
* **base-driver:** update dependency express to v4.19.2 ([7cb1621](https://github.com/TestSpectra/appium/commit/7cb1621e80bc4225c48833cc2bd02fe80dccd382))
* **base-driver:** update dependency express to v4.20.0 ([ef163eb](https://github.com/TestSpectra/appium/commit/ef163eb8df512e89f4e62c99b32fc979008fcfaa))
* **base-driver:** update dependency express to v4.21.0 ([cb9fb9c](https://github.com/TestSpectra/appium/commit/cb9fb9c6fef608e29284210be27356a488f4002c))
* **base-driver:** update dependency express to v4.21.1 ([0e52da4](https://github.com/TestSpectra/appium/commit/0e52da4b3adbd5ecde09395063255c3af7eb0400))
* **base-driver:** update dependency express to v4.21.2 ([#20823](https://github.com/TestSpectra/appium/issues/20823)) ([c032352](https://github.com/TestSpectra/appium/commit/c032352fade2146cdce5feb0906726ad07a30e4f))
* **base-driver:** update dependency http-status-codes to v2.3.0 ([331171d](https://github.com/TestSpectra/appium/commit/331171dd8c511aba15e1b5b24329b30224e3e6ac))
* **base-driver:** update dependency path-to-regexp to v6.2.2 ([#19979](https://github.com/TestSpectra/appium/issues/19979)) ([b8368bb](https://github.com/TestSpectra/appium/commit/b8368bb666fda44e3b0c45cc7307bff69fe40202))
* **base-driver:** update dependency path-to-regexp to v7 ([#20279](https://github.com/TestSpectra/appium/issues/20279)) ([a746eef](https://github.com/TestSpectra/appium/commit/a746eefbbb627c7f7dd9d1ce13226a88d9527129))
* **base-driver:** update dependency path-to-regexp to v7.1.0 ([#20376](https://github.com/TestSpectra/appium/issues/20376)) ([6488a0a](https://github.com/TestSpectra/appium/commit/6488a0a4e1dd08f4eda6e40e33a9b31d31edda1c))
* **base-driver:** update dependency path-to-regexp to v8 ([#20520](https://github.com/TestSpectra/appium/issues/20520)) ([63cb664](https://github.com/TestSpectra/appium/commit/63cb664af13d7411ff325095cd0e9b6fd24363c3))
* **base-driver:** update dependency path-to-regexp to v8.1.0 ([#20562](https://github.com/TestSpectra/appium/issues/20562)) ([1cae549](https://github.com/TestSpectra/appium/commit/1cae549a7be5138e980af6661b96cd7d6268fdb0))
* **base-driver:** update dependency path-to-regexp to v8.2.0 ([e8886ae](https://github.com/TestSpectra/appium/commit/e8886ae0d276ac4f97a1bdb88998fc30fbd936fa))
* **base-driver:** Update parseCapsArray function types ([#21045](https://github.com/TestSpectra/appium/issues/21045)) ([5541142](https://github.com/TestSpectra/appium/commit/554114203fbe26f303337f049f942e046c815074))
* **base-driver:** Update the web socket upgrade behavior ([#20142](https://github.com/TestSpectra/appium/issues/20142)) ([275790e](https://github.com/TestSpectra/appium/commit/275790ec012d0c773b1248c3c2a541301cf0167b))
* **base-driver:** update type for logExtraCaps ([28876c1](https://github.com/TestSpectra/appium/commit/28876c19f3544ca4dc4efb7c5ed48b9c72fab7fa))
* **base-driver:** Update/simplify the logic for logger prefix ([#16683](https://github.com/TestSpectra/appium/issues/16683)) ([a9651d3](https://github.com/TestSpectra/appium/commit/a9651d3c59caf0b1be1b85b5185192578925f3ac))
* **base-driver:** use new mixin strategy ([be86627](https://github.com/TestSpectra/appium/commit/be8662759586bb3c24c7635b60ed8c574f5e2fd4))
* **base-driver:** Use proper cached headers for app download ([#18874](https://github.com/TestSpectra/appium/issues/18874)) ([75650a6](https://github.com/TestSpectra/appium/commit/75650a6b744dfcbd50d45972f04040472fdbcd45))
* **base-driver:** use random ports in tests ([ff3c74f](https://github.com/TestSpectra/appium/commit/ff3c74f41048502a2e7f2201dc2285fc3b9bebc6))
* **base-driver:** Use shouldUpgradeCallback for proper upgrades processing ([#21706](https://github.com/TestSpectra/appium/issues/21706)) ([fc273da](https://github.com/TestSpectra/appium/commit/fc273da0ef04d3362f10c710f7c8692d7a03fd21))
...
* **basedriver,types:** fix type problems ([226cd01](https://github.com/TestSpectra/appium/commit/226cd018b408ba93f737b7ae58646c2ba2375eb1))
* **basedriver:** allow arbitrary session data to be returned by getSession ([6245022](https://github.com/TestSpectra/appium/commit/6245022be953b69acad70d0a4c877bc65eed2d3a))
* **basedriver:** convert main driver implementation to typescript ([deb631b](https://github.com/TestSpectra/appium/commit/deb631b4562a0f99e4061c89a7ad21b0621f8a47)), closes [#18379](https://github.com/TestSpectra/appium/issues/18379) [#18379](https://github.com/TestSpectra/appium/issues/18379)
* **basedriver:** ensure "opts" is defined at time of construction ([51d6d69](https://github.com/TestSpectra/appium/commit/51d6d69ff13a0cc23d612257926c02892685dcee))
* change cache logic ([#21380](https://github.com/TestSpectra/appium/issues/21380)) ([34eb1c2](https://github.com/TestSpectra/appium/commit/34eb1c25c71ef08f739257960167bcbbcafa3e51))
* do not print deprecation errors for non-provided caps ([#19986](https://github.com/TestSpectra/appium/issues/19986)) ([9f655f6](https://github.com/TestSpectra/appium/commit/9f655f6f852bc10ca1f51529183c7c44eb4c79ea))
...
* **driver-test-support:** update definitelytyped ([e3bce2b](https://github.com/TestSpectra/appium/commit/e3bce2b6be0ea072ec5e8472c0e191bdfea52a06))
* **driver-test-support:** update definitelytyped ([958fca4](https://github.com/TestSpectra/appium/commit/958fca47c8515664aac4c2f0b1051cadd43431b9))
* **driver-test-support:** update definitelytyped ([a8d36b0](https://github.com/TestSpectra/appium/commit/a8d36b0a981daf524bd4af422904193c087a8c2c))
* **driver-test-support:** update definitelytyped ([4776574](https://github.com/TestSpectra/appium/commit/47765747b66c5e0076f6ffe4619d6b98a42aee29))
* **driver-test-support:** update definitelytyped ([c320e8a](https://github.com/TestSpectra/appium/commit/c320e8a1a61cb6d980d6d944ae47b60da97aa398))
* **driver-test-support:** update definitelytyped ([#20605](https://github.com/TestSpectra/appium/issues/20605)) ([da7a4fd](https://github.com/TestSpectra/appium/commit/da7a4fdce8790bc59370bfe4b912c7c0c403c713))
* **driver-test-support:** update definitelytyped ([#20942](https://github.com/TestSpectra/appium/issues/20942)) ([f7c63ee](https://github.com/TestSpectra/appium/commit/f7c63ee5d87be21eba577a4cfd0b0a08a050afeb))
* **driver-test-support:** update dependency @types/lodash to v4.14.197 ([a080b72](https://github.com/TestSpectra/appium/commit/a080b729208b4e3c352456f0f230b63b0b7ee9ee))
* **driver-test-support:** update dependency @types/lodash to v4.14.198 ([84fefd2](https://github.com/TestSpectra/appium/commit/84fefd214c40408cbbcd145723b5d8dbeec665af))
* **driver-test-support:** update dependency @types/lodash to v4.17.10 ([a2b0ba8](https://github.com/TestSpectra/appium/commit/a2b0ba877310737f1ebf7ecda0b9aa5d7083e1f4))
* **driver-test-support:** update dependency @types/lodash to v4.17.14 ([#20877](https://github.com/TestSpectra/appium/issues/20877)) ([fe209ed](https://github.com/TestSpectra/appium/commit/fe209ed660e0f790c98cd51938d0c75712cfd8e4))
* **driver-test-support:** update dependency @types/lodash to v4.17.5 ([69bbb53](https://github.com/TestSpectra/appium/commit/69bbb5370e671d2809a5bf997936b0b3cc1a0a0b))
* **driver-test-support:** update dependency @types/lodash to v4.17.6 ([82e40c1](https://github.com/TestSpectra/appium/commit/82e40c1400e23f341c45d788982ccc5905827d7c))
* **driver-test-support:** update dependency @types/lodash to v4.17.7 ([#20382](https://github.com/TestSpectra/appium/issues/20382)) ([d5ef0f9](https://github.com/TestSpectra/appium/commit/d5ef0f9c8608ba545988c3016cefd0669f2400dc))
...
* remove BASEDRIVER_HANDLED_SETTINGS ([#16368](https://github.com/TestSpectra/appium/issues/16368)) ([5aae1ae](https://github.com/TestSpectra/appium/commit/5aae1ae8a70495f4b2ff230b0881acb5b7b59d76))
* revert 15809 ([#16621](https://github.com/TestSpectra/appium/issues/16621)) ([3ee93ba](https://github.com/TestSpectra/appium/commit/3ee93ba5bd44268692bee5853b39f6b7ce593d7e))
* **schema:** update definitelytyped ([e967240](https://github.com/TestSpectra/appium/commit/e96724077ef2b5b8aae203856195f3bb8de56116))
...
* **types,base-driver:** remove deviceName from base constraints ([01061b2](https://github.com/TestSpectra/appium/commit/01061b291981333bdec59adfbea60f0cef3d69c1))
* **types:** separate the type of opts from initialOpts ([d6cca51](https://github.com/TestSpectra/appium/commit/d6cca5175c3e55d4670936c9d216cd3a6610d16b))
* **types:** update definitelytyped ([96b0a44](https://github.com/TestSpectra/appium/commit/96b0a44629c451102c44541a8d5b9e7be972f1ea))
* **types:** update definitelytyped ([172bdae](https://github.com/TestSpectra/appium/commit/172bdae436efa75c5928972322d260184c225dd6))
* **types:** update definitelytyped ([172fcb9](https://github.com/TestSpectra/appium/commit/172fcb9aff0afe5295650566c4fb92d0894bf879))
* **types:** update dependency @types/express to v4.17.16 ([644f300](https://github.com/TestSpectra/appium/commit/644f300cd87edbf3788eb82c4c88f6b773e653b0))
* **types:** update dependency @types/express to v5 ([#20620](https://github.com/TestSpectra/appium/issues/20620)) ([69e9abe](https://github.com/TestSpectra/appium/commit/69e9abeed3ac5a2f61d8b7f1cd4ec4bd9c054cf1))
...
* **types:** various fixes for reality ([81bc527](https://github.com/TestSpectra/appium/commit/81bc527be6aa54dd30a012156b5752b8b821ac0c))
* update axios to v1.3.3 ([8f9de63](https://github.com/TestSpectra/appium/commit/8f9de63e4a622712db545ab63f9f4ce6654e4a91))
* Update property name after lru-cache package bump ([#16446](https://github.com/TestSpectra/appium/issues/16446)) ([1165269](https://github.com/TestSpectra/appium/commit/1165269644f8151b31730e920d9576c05e8072f4))
* Use pathToRegexp to match websocket endpoints ([#19162](https://github.com/TestSpectra/appium/issues/19162)) ([de02ed8](https://github.com/TestSpectra/appium/commit/de02ed87fc665ec9c6e563a634634307c3f21e44))


### Reverts

* **base-driver:** "chore: merge base-driver master (de7e41b) to base-driver for 2.0" ([#15454](https://github.com/TestSpectra/appium/issues/15454)) ([254cc63](https://github.com/TestSpectra/appium/commit/254cc638c52063149878866c2abdfe83c5dbee7b))
...
* update @appium/fake-driver to use @appium/base-driver ([#15436](https://github.com/TestSpectra/appium/issues/15436)) ([c66144d](https://github.com/TestSpectra/appium/commit/c66144d62b23681f91b45c45648dddf51f0ea991)), closes [#15425](https://github.com/TestSpectra/appium/issues/15425)


### Code Refactoring

* **appium:** remove support for -custom locator strategy(should be handled by plugins instead) ([#15452](https://github.com/TestSpectra/appium/issues/15452)) ([9331969](https://github.com/TestSpectra/appium/commit/9331969c23bbb9c137a7ee56fb126a0dd10c67c6))

...
## [2.0.1](https://github.com/TestSpectra/appium/compare/@testspectra/types@2.0.0...@testspectra/types@2.0.1) (2026-04-28)
...
* **types:** Add an optional `info` field to base method type definitions ([#20917](https://github.com/TestSpectra/appium/issues/20917)) ([fe4ffc1](https://github.com/TestSpectra/appium/commit/fe4ffc159a87cb7566775203efe4659d1508b5b0))
* **types:** add new @appium/types package ([72085ca](https://github.com/TestSpectra/appium/commit/72085caa0a4030d8495fa1c66b092069aeebb20b))
* **types:** add orientation type; add optional ELEMENT prop of Element ([ab5b285](https://github.com/TestSpectra/appium/commit/ab5b285714a804a3a665723e893b82bd93e25854))
* **types:** adds types to derive capabilities from constraints ([4abe910](https://github.com/TestSpectra/appium/commit/4abe91004d4089e4280494a6d285b074c33a43c1))
...
* **deps:** update definitelytyped ([#20928](https://github.com/TestSpectra/appium/issues/20928)) ([1f65cf6](https://github.com/TestSpectra/appium/commit/1f65cf6555a18d3ba02b4506942b4217839618ff))
...
* **scripts:** properly import log-symbols in scripts ([#21819](https://github.com/TestSpectra/appium/issues/21819)) ([e9a6e54](https://github.com/TestSpectra/appium/commit/e9a6e5425cfd7f148ac2258a69884b4c3f2dbce3))
...
* **types,fake-driver:** getLog doesn't necessarily return an array ([00ae162](https://github.com/TestSpectra/appium/commit/00ae1625d73305b8840d45a0dc98ac3cc628ac37))
* **types:** add inclusionCaseInsensitive to Constraint type ([74378cc](https://github.com/TestSpectra/appium/commit/74378cca66b365083850d189e5922de3a2c5f488))
* **types:** add method for elementShadowRoot ([47b0df0](https://github.com/TestSpectra/appium/commit/47b0df06ecb6f0a66a0f70c71ede9755557dbc71))
* **types:** add missing @types/ws dep ([1597037](https://github.com/TestSpectra/appium/commit/159703744f18566bf3a46e0a2c5b9ac0073e5458))
* **types:** base cap webSocketUrl is now a boolean instead of a string. ([24fb515](https://github.com/TestSpectra/appium/commit/24fb515a52349058a8c9b69eafa531876880dffd))
* **types:** callback to implicitWaitForCondition accepts args ([5684c4e](https://github.com/TestSpectra/appium/commit/5684c4e2860d7f7043c6252f1e447a653b49955a))
* **types:** commit type gen update ([#20445](https://github.com/TestSpectra/appium/issues/20445)) ([7a14f9f](https://github.com/TestSpectra/appium/commit/7a14f9f929a2d481454538842dce1d684a24de80))
* **types:** Driver extends ExecuteCommands ([#17363](https://github.com/TestSpectra/appium/issues/17363)) ([b594799](https://github.com/TestSpectra/appium/commit/b5947991cff4f78fd4e0de4155d10f47f75a19f9)), closes [#17359](https://github.com/TestSpectra/appium/issues/17359)
* **types:** driver-specific session data now allowed ([91abd5b](https://github.com/TestSpectra/appium/commit/91abd5b598dd55e8d7fd12d2e683703aa8ac290a))
* **types:** ensure return type of deleteSession can always be void ([ee9b2a3](https://github.com/TestSpectra/appium/commit/ee9b2a30dee4a24b351375862883986e6d4e618c))
* **types:** fix declaration for AppiumServer['close'] ([b8df5b5](https://github.com/TestSpectra/appium/commit/b8df5b5c38a9e1741af3386acf49a842a82648fc))
* **types:** fix driverForSession declaration ([4d7d8e4](https://github.com/TestSpectra/appium/commit/4d7d8e4d38563aca5e9070ecab30aecad3205937))
* **types:** fix method map types ([5485f0b](https://github.com/TestSpectra/appium/commit/5485f0b9cd5c33dfeca61f1599edb40b2087479e))
* **types:** fix signature of updateSettings ([24e7aec](https://github.com/TestSpectra/appium/commit/24e7aeca7dcab69e84e797e9e3168492d0e70e83))
* **types:** generate constraints via babel ([96e30ad](https://github.com/TestSpectra/appium/commit/96e30ad5372af1a7659f546b45d23c6d9cda9490))
* **types:** make getContext & getContexts generic ([296c29a](https://github.com/TestSpectra/appium/commit/296c29ad8499d8ac132a785580d71617fdaf3e18))
...
* **types:** type fixes & improvements ([e2aa3d3](https://github.com/TestSpectra/appium/commit/e2aa3d3b32235072c99647c3a0bad5adc1965b22))
...
* **types:** update dependency @types/ws to v8.5.11 ([b1b7c33](https://github.com/TestSpectra/appium/commit/b1b7c33eddcd8b098cd092ecc5a47d97b983b792))
* **types:** update dependency @types/ws to v8.5.13 ([95406b6](https://github.com/TestSpectra/appium/commit/95406b603e48a3f78ac11bcbbf32e13596e1eb33))
* **types:** update dependency @types/ws to v8.5.4 ([6055f16](https://github.com/TestSpectra/appium/commit/6055f162d8781da99cbdff6859ca8af5a9538040))
...
* **types:** update some more types to reflect reality ([62f4244](https://github.com/TestSpectra/appium/commit/62f4244753b450eb0c9b96483a8b04a40ef289d2))
...
* **types:** use overload instead of broken conditional type in findElOrEls ([63a5c22](https://github.com/TestSpectra/appium/commit/63a5c22127ab22acfde8d36e9b96bdd35614fe17))

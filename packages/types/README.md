...
```bash
npm install @testspectra/types -D
```
...
> - `lib/appium-config.ts` is generated by this package from `@testspectra/schema`, but is under version control to avoid chicken-or-egg build problems.

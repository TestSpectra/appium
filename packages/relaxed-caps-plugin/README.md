# @testspectra/relaxed-caps-plugin

> Appium plugin for handling extension capabilities with no prefix

[![NPM version](http://img.shields.io/npm/v/@testspectra/relaxed-caps-plugin.svg)](https://npmjs.org/package/@testspectra/relaxed-caps-plugin)
[![Downloads](http://img.shields.io/npm/dm/@testspectra/relaxed-caps-plugin.svg)](https://npmjs.org/package/@testspectra/relaxed-caps-plugin)
